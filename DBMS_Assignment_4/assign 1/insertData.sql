...
INSERT INTO `lis`.`members` (`member_id`, `member_nm`, `addressLine1`, `addressLine2`, `category`) VALUES (13, 'Jhon Snow', 'mansrover', 'sitapura', 'M');

INSERT INTO `lis`.`books` (`accession_no`, `title_id`, `purchase_dt`, `price`, `status`) VALUES (6, 2, '2016-05-05', 985, 'M');

INSERT INTO `lis`.`books` (`accession_no`, `title_id`, `purchase_dt`, `price`, `status`) VALUES (7, 3, '2016-02-03', 825, 'F');