		...
		<section id="contact-form">
			...
			<form action="CarFacade"  method="post" >
				...
				<div class="line">
					...
					<span><i class="fa fa-car" aria-hidden="true"></i></span> <input
				...
				<div class="line">
					...
					<span><i class="fa fa-cc" aria-hidden="true"></i></span> <input
				...
				<div class="line">
					...
					<span><i class="fa fa-minus-circle" aria-hidden="true"></i></span> <input
				...
				<div class="line">
					...
					<span><i class="fa fa-road" aria-hidden="true"></i></span> <input
				...
				<div class="line">
					...
					<span><i class="fa fa-credit-card-alt" aria-hidden="true"></i></span> <input
